        ...
        <main className="container mx-auto px-4">
          <div className="my-8">
            ...
            <p className="text-lg mb-4">
              Have a question or feedback about BlogsHub? We&apos;d love to hear from you! Please use the form below to contact our team and we&apos;ll get back to you as soon as possible.
            </p>
            <form className="mb-8">
              <div className="mb-4">
